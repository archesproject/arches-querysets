"""
Django settings for arches_querysets project.
"""
...
DATATYPE_LOCATIONS.append("arches_querysets.datatypes")
FUNCTION_LOCATIONS.append("arches_querysets.functions")
ETL_MODULE_LOCATIONS.append("arches_querysets.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches_querysets.search_components")
...
SECRET_KEY = "django-insecure-7xnft806s-44r+zchr-*f4cpss&@e6-5r_o0gn+apw6zb*#$p7"
...
ELASTICSEARCH_PREFIX = "arches_querysets"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_querysets.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = "arches_querysets.wsgi.application"
...
SESSION_COOKIE_NAME = "arches_querysets"
